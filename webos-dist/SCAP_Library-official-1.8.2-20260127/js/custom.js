  ...
  (c.prototype.Configuration = {
    getCustomJSVersion: function (e, a) {
      w('getCustomJSVersion', a, function () {
        y.callSuccessCallback(e, { version: '1.4210930' });
      });
    },
    ...
    setPortControl: function (a, t, n) {
      w('setPortControl', t, function () {
        ...
        } else y.callFailureCallback(t, {}, c.ERROR_CODE.COMMON.BAD_PARAMETERS, 'Missing required parameters.');
      });
    },
        ...
        w('disableApplication', t, function () {
          ...
          if (!0 === D.checkMissingParameters(n, ['reset'])) {
            ...
            !0 === n.reset &&
              ...
              (e.fqdnMode = 'off'),
              (e.fqdnAddr = 'http://'));
          } else y.callFailureCallback(t, {}, c.ERROR_CODE.COMMON.BAD_PARAMETERS, 'Application will be disabled after reboot only if reset property is true.');
          F.setValue(
            R,
            e,
            function () {
